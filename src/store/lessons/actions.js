...
export const sendEssay = (student_id, topic, text, comment, lesson_id, teacher_id, score_names) => {
  return {
...
export const setScoreStudent = (teacher_id, teacher_text, score, essay_id, check) => {
  return {
